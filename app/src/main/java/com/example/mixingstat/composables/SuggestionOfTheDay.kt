    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(text = "Category: ${StringUtils.defaultIfNull(cocktail.strCategory)}")
                Text(text = "Alcoholic: ${StringUtils.defaultIfNull(cocktail.strAlcoholic)}")
                Text(text = "Glass: ${StringUtils.defaultIfNull(cocktail.strGlass)}")
            }
        }
    }
}